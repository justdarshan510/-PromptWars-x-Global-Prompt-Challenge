                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2.5 pt-2">
                    ...
                    <button 
                      ...
                      className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 py-2.5 px-4 rounded-xl text-xs font-bold transition-all shadow-sm"
                    >
