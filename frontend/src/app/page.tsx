      ...
      if (typeof window !== "undefined" && (window as any).google?.accounts?.id) {
        ...
        try {
          (window as any).google.accounts.id.initialize({
            client_id: process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || "72175965416-8310q42mopq336v2pln3n7h58i3j8s09.apps.googleusercontent.com",
                  ...
                  <div className="space-y-2.5 pt-2">
                    ...
                    <button 
                      onClick={() => {
                        ...
                        setTimeout(() => {
                          setGoogleLoading(false);
                          setGoogleAccounts(true);
                        }, 1000);
                      }}
                      className="w-full flex items-center justify-center gap-3 bg-blue-50 hover:bg-blue-100/80 text-blue-700 py-2.5 px-4 rounded-xl text-xs font-bold transition-all shadow-sm"
                    >
                    ...
                    <p className="text-[8.5px] text-gray-400 leading-normal text-left pt-1">
                      ⚠️ Note: Real Google Login requires setting <code className="bg-slate-100 px-1 py-0.5 rounded text-red-500 font-mono">NEXT_PUBLIC_GOOGLE_CLIENT_ID</code> inside <code className="bg-slate-100 px-1 py-0.5 rounded font-mono">.env.local</code>. Otherwise, please use <b>Demo Account</b> or <b>Mobile OTP</b>.
                    </p>
                  </div>
                </div>
              )}
